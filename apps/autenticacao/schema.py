...
Sem esta extensão, o drf-spectacular ignora silenciosamente o esquema de
segurança de ``AutenticacaoApiKey`` e o Swagger UI não exibe o campo de
API Key para os endpoints protegidos.
"""
